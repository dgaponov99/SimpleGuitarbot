...
to_offer = 'Отправить'
agree = 'Добавить'
disagree = 'Не добавлять'
done = 'Уже добавил'
not_exist = 'Такого аккорда не существует'
message_to_admins = 'Пользователь {} (chat_id="{}") отправил на рассмотрение аккорд "{}"'
message_to_users_agree = 'Мы рассмторим ваше предложение'
message_to_users_disagree = 'Мы не нашли такого аккорда в глобальной сети'
message_to_users_done = 'Ваш аккорд добавлен'
message_to_admins_agree = ' берется за работу'
message_to_admins_disagree = ' сказал, что можно отдохнуть'
message_to_admins_done = ' уже все сделал'
# -----------------------------------------------------------------------------------------
...
• /tutorials - выводит список командочек, каждая из которых поможет Вам научиться чему-нибудь
...
Обнаружен баг для IPhone (не работает камертон), мы пытаемся решить эту проблему. 
"""
