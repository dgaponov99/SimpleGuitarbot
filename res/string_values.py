...
<b>4. Безопасность.</b> 
Всегда храните гитару в чехле, потому что он уменьшает воздействие окружающей среды на инструмент и защищает его от загрязнений во время путешествий. (и ни одной тупой шутки, расту)
"""
